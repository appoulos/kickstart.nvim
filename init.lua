...
require('lazy').setup({
  ...
  },
  {
    ...
    dependencies = {
      ...
      -- apoulos bottom right messages are distracting!!!
    ...
    config = function()
      ...
      local servers = {
        ...
        gopls = {
          settings = {
            gopls = {
              ...
              -- semanticTokens = true, -- ap supposed to display shadowed vars in bold
            },
          },
        },
        ...
        --     gopls = {
        --       analyses = {
        --         -- Enable the shadow analysis
        --         shadow = true,
        --       },
        --       -- Optional: configure other analyses
        --       unusedwrite = true,
        --       -- unusedvariable = true,
        --     },
        --     -- Optional: enable inlay hints if desired
        --     hints = {
